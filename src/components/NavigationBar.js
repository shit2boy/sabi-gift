...
function NavigationBar() {
  ...
  <Navbar.Brand href="#home"><img src={logo}  alt='SabigiftLogo' width='65px'/></Navbar.Brand>
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="mx-auto" id='navItems'>
      ...
      <Nav.Link className="pv-2 ml-2 " href="#">CREATE REGISTRY</Nav.Link>
      <Nav.Link className="pv-3 ml-2 " href="#">FIND AN EVENT</Nav.Link>
    </Nav>
 </Navbar.Collapse>
