        ...
        <div className='container-fluid mt-4 '>
           <div className='row no-gutters'>
               ...
               <div className='col-sm mt-2' style={{backgroundColor:'#D2F5D9'}} data-aos="fade-right">
                   <div className=' why'>
                   <h3 className='text-center'>Why we built SabiGifts</h3>
                    ...
                    <p> <a href='/r' style={{backgroundColor:'#545871',borderRadius:'1.25rem'}} className='p-2 mt-3 mb-4 text-white '>Create a registry</a></p> 
                   </div>
               </div>
            </div> 
        </div>
